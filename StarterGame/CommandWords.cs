...
namespace StarterGame
{
    ...
    public class CommandWords
    {
        ...
        private static Command[] _commandArray = { new GoCommand(), new QuitCommand(),new InspectCommand(), new PickUpCommand(), new DropCommand(), new InventoryCommand(), new GiveCommand(), new TalkToCommand(), new AttackCommand(), new EatCommand()};
